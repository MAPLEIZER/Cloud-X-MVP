...
export default function SystemMonitor() {
  ...
  const [agents] = useState<Agent[]>([
    { id: "1", name: "Network Scanner", memory: [], color: "#3b82f6" },
    { id: "2", name: "Wazuh Agent", memory: [], color: "#10b981" },
    { id: "3", name: "Security Monitor", memory: [], color: "#f59e0b" },
    { id: "4", name: "Threat Detection", memory: [], color: "#8b5cf6" },
  ])
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-lg font-semibold">Cloud-X System Monitor</span>
            </div>
            {hasAnySpikes && (
              <motion.div
                initial={{ scale: 0 }}
              ...
              >
                <Badge variant="destructive" className="text-xs text-white px-2 py-1 animate-pulse">
