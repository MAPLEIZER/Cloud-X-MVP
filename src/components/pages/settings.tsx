...
export function Settings() {
  ...
  const [scanNotifications, setScanNotifications] = useState(
    state.settings.notifications.scanComplete
  )
  const [alertNotifications, setAlertNotifications] = useState(
    state.settings.notifications.securityAlerts
  )
  const [systemNotifications, setSystemNotifications] = useState(
    state.settings.notifications.systemStatus
  )
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          <div className='flex items-center space-x-2'>
            ...
            />
            <Label htmlFor='scan-notifications'>
              Network scan completion notifications
            </Label>
          </div>
          <div className='flex items-center space-x-2'>
            <Switch
