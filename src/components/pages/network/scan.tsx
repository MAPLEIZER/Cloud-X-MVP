...
export function NetworkScan() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const needsPort = scanOptions[formData.tool].find(
    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select your target, scanning tool, and scan type to begin security
            analysis
          </CardDescription>
        </CardHeader>
